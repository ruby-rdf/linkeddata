...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency     'rdf-json',       '~> 1.1'
  gem.add_runtime_dependency     'rdf-microdata',  '~> 2.0'
  ...
  gem.add_runtime_dependency     'rdf-turtle',     '~> 1.1', '>= 1.1.5'
  gem.add_runtime_dependency     'json-ld',        '~> 1.1', '>= 1.1.7'
  gem.add_runtime_dependency     'sparql',         '~> 1.1', '>= 1.1.4'
  gem.add_runtime_dependency     'sparql-client',  '~> 1.1', '>= 1.1.3'
  gem.add_runtime_dependency     'nokogiri',       '~> 1.6'
  gem.add_runtime_dependency     'equivalent-xml', '~> 0.4'
