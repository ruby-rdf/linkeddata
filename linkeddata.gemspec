...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency     'rdf-json',       '>= 1.99', '< 3'
  gem.add_runtime_dependency     'rdf-microdata',  '~> 2.0', '>= 2.0.2'
  gem.add_runtime_dependency     'rdf-n3',         '>= 1.99', '< 3'
  gem.add_runtime_dependency     'rdf-rdfa',       '>= 1.99', '< 3'
  gem.add_runtime_dependency     'rdf-rdfxml',     '>= 1.99', '< 3'
  gem.add_runtime_dependency     'rdf-reasoner',   '>= 0.3'
  gem.add_runtime_dependency     'rdf-tabular',    '~> 0.3'
  gem.add_runtime_dependency     'rdf-trig',       '>= 1.99', '< 3'
  gem.add_runtime_dependency     'rdf-trix',       '>= 1.99', '< 3'
  ...
  gem.add_runtime_dependency     'json-ld',        '>= 1.99', '< 3'
  gem.add_runtime_dependency     'sparql',         '>= 1.99', '< 3'
  gem.add_runtime_dependency     'sparql-client',  '>= 1.99', '< 3'
