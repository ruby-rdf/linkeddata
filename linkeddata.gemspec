...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency     'rdf-microdata',  '>= 1.1.1'
  gem.add_runtime_dependency     'rdf-n3',         '>= 1.1.0'
  gem.add_runtime_dependency     'rdf-rdfa',       '>= 1.1.1'
  gem.add_runtime_dependency     'rdf-rdfxml',     '>= 1.1.0'
  gem.add_runtime_dependency     'rdf-trig',       '>= 1.1.2'
  gem.add_runtime_dependency     'rdf-trix',       '>= 1.1.0'
  gem.add_runtime_dependency     'rdf-turtle',     '>= 1.1.2'
  gem.add_runtime_dependency     'json-ld',        '>= 1.1.1'
  gem.add_runtime_dependency     'sparql',         '>= 1.1.2'
  gem.add_runtime_dependency     'sparql-client',  '>= 1.1.1'
  gem.add_runtime_dependency     'nokogiri',       '>= 1.6.1'
  gem.add_runtime_dependency     'equivalent-xml', '>= 0.4.0'
