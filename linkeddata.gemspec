...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency     'rdf-microdata',       '~> 3.1', '>= 3.1.1'
  ...
  gem.add_runtime_dependency     'rdf-reasoner',        '~> 0.6', '>= 0.6.2'
  gem.add_runtime_dependency     'rdf-tabular',         '~> 3.1', '>= 3.1.1'
  gem.add_runtime_dependency     'rdf-trig',            '~> 3.1', '>= 3.1.1'
  gem.add_runtime_dependency     'rdf-trix',            '~> 3.1'
  gem.add_runtime_dependency     'rdf-turtle',          '~> 3.1', '>= 3.1.3'
  gem.add_runtime_dependency     'rdf-vocab',           '~> 3.1', '>= 3.1.10'
