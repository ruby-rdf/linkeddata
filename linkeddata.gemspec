...
Gem::Specification.new do |gem|
  ...
  gem.requirements               = []
  gem.add_runtime_dependency     'rdf',                 '~> 3.3', '>= 3.3.2'
  ...
  gem.add_runtime_dependency     'rdf-json',            '~> 3.3'
  gem.add_runtime_dependency     'rdf-microdata',       '~> 3.3'
  gem.add_runtime_dependency     'rdf-n3',              '~> 3.3', '>= 3.3.1'
  gem.add_runtime_dependency     'rdf-normalize',       '~> 0.7'
  gem.add_runtime_dependency     'rdf-ordered-repo',    '~> 3.3'
  gem.add_runtime_dependency     'rdf-rdfa',            '~> 3.3'
  gem.add_runtime_dependency     'rdf-rdfxml',          '~> 3.3'
  gem.add_runtime_dependency     'rdf-reasoner',        '~> 0.9'
  gem.add_runtime_dependency     'rdf-tabular',         '~> 3.3'
  gem.add_runtime_dependency     'rdf-trig',            '~> 3.3'
  gem.add_runtime_dependency     'rdf-trix',            '~> 3.3'
  gem.add_runtime_dependency     'rdf-turtle',          '~> 3.3', '>= 3.3.1'
  gem.add_runtime_dependency     'rdf-vocab',           '~> 3.3', '>= 3.3.2'
  gem.add_runtime_dependency     'rdf-xsd',             '~> 3.3'
  gem.add_runtime_dependency     'json-ld',             '~> 3.3', '>= 3.3.2'
  gem.add_runtime_dependency     'json-ld-preloaded',   '~> 3.3', '>= 3.3.1'
  gem.add_runtime_dependency     'ld-patch',            '~> 3.3', '>= 3.3.1'
  gem.add_runtime_dependency     'shacl',               '~> 0.4', '>= 0.4.2'
  gem.add_runtime_dependency     'shex',                '~> 0.8', '>= 0.8.1'
  gem.add_runtime_dependency     'sparql',              '~> 3.3', '>= 3.3.2'
  gem.add_runtime_dependency     'sparql-client',       '~> 3.3'
  gem.add_runtime_dependency     'nokogiri',            '~> 1.18', '>= 1.18.8'
  #gem.add_runtime_dependency     'equivalent-xml',      '~> 0.6'
  gem.add_runtime_dependency     'yaml-ld',             '~> 0.0', '>= 0.0.3'
